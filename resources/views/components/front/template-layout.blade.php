                        ...
                        <div class="header-row">
                            <div class="header-logo">
                                <a href="demo-hotel.html">
                                    <img alt="Porto" width="122" height="50" src="{{asset('porto/img/demos/hotel/logo.png')}}">
                                </a>
                            </div>
                        </div>
                    </div>
            ...
            <div id="revolutionSlider" class="slider rev_slider manual" data-version="5.4.8">
                <ul>
                    ...
                    <li data-transition="boxfade">
                        ...
                        <img src="{{asset('porto/img/demos/hotel/slides/slide-hotel-2.jpg')}}"
                             alt=""
                             data-bgposition="center bottom"
                             data-bgfit="cover"
                             data-bgrepeat="no-repeat"
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6">
                        ...
                        <h3 class="mt-4 mb-0 pb-0">Wisata Pulau Pahawang</h3>
                        <div class="divider divider-primary divider-small my-3">
                            <hr class="mt-2 me-auto">
                        </div>

                        <p class="lead font-weight-regular"><span class="highlight highlight-primary highlight-bg-opacity highlight-animated px-0" data-appear-animation="highlight-animated-start" data-appear-animation-delay="200" data-plugin-options="{'flagClassOnly': true}">Pulau Pahawang</span> salah satu destinasi.</p>

                        <p class="mt-4">Pulau Pahawang adalah salah satu tujuan wisata favorit dan populer di Provinsi Lampung. Terkenal akan keindahan baharinya, termasuk bawah lautnya. Saat ini sudah banyak penginapan di sekitar pulau dengan berbagai .</p>

                        <a class="font-weight-bold text-2 text-decoration-none mt-2 mb-4" href="{{route('frontend.pahawang')}}">Detail <i class="fas fa-angle-right p-relative top-1 ms-1"></i></a>
                    </div>
                    <div class="col-lg-6">
